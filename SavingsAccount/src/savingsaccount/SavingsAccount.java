...
public class SavingsAccount {
    ...
    static double annualInterestRate;   //Global variable
    double savingsBalance;  //Class variable
    
    //Constructor
    //Defines savingBalance
    public SavingsAccount(double x){
        savingsBalance = x;
    }
    //Calculates interest and adds to the savingsBalance
    public void calculateMonthlyInterest(){
        savingsBalance += ((savingsBalance*annualInterestRate)/12);
    }
    //Defines annualInterestRate
